...
import { settingUpYourFirstDevEnvironmentWithoutLosingYourMind } from './setting-up-your-first-dev-environment-without-losing-your-mind';
import { sqlVsNoSqlStopPickingTheTrendyOneAndPickTheRightOne } from './sql-vs-nosql-stop-picking-the-trendy-one-and-pick-the-right-one';
...
export const blogs: BlogPost[] = [
  ...
  typescriptMadeMeABetterJavaScriptDeveloperEvenWhenIHatedIt,
  whyYourCodeWorksButNobodyCanMaintainIt,
  sqlVsNoSqlStopPickingTheTrendyOneAndPickTheRightOne,
  stateVsPropsTheConfusionThatTripsUpEveryReactDeveloper,
  theSingleResponsibilityPrincipleWillChangeHowYouWriteCode,
  asyncAwaitIsJustPromisesWithABetterCostume,
  settingUpYourFirstDevEnvironmentWithoutLosingYourMind,
  loopsMakingYourComputerDoTheBoringStuff,
  apisExplainedWithoutTheBuzzwords,
  gitIsNotComplicated,
];
